...
- (void)viewDidLoad {
    ...
    _segmentedControl.selectedSegmentIndex = 0;  [self changeSource];
    if(_placeType == PlaceTypeDeparture) {  self. title =  @"Откуда";
    }
    else
    {
        self.title = @"Куда";
...
- (UITableViewCell *)tableView:( UITableView *)tableView cellForRowAtIndexPath:( NSIndexPath *)indexPath
{
    ...
    {
        Airport *airport = [_currentArray objectAtIndex:indexPath.row]; cell.textLabel.text = airport.name;
